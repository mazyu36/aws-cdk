...
export class ManagedMemoryStrategy implements IMemoryStrategy {
  ...
  public render(): bedrockagentcore.CfnMemory.MemoryStrategyProperty {
    ...
    const reflectionMemoryRecordSchema = renderMemoryRecordSchema(this.reflectionConfiguration?.metadataSchema);
      ...
      return {
        episodicMemoryStrategy: {
          ...
          reflectionConfiguration: {
            ...
            memoryRecordSchema: reflectionMemoryRecordSchema,
          },
        },
      };
    }
